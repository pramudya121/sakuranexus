...
import { TrendingUp, TrendingDown, Droplets, BarChart3, Star, ExternalLink, Zap, Info } from 'lucide-react';
...
const PoolCardEnhanced = memo(({ pool, compact = false }: PoolCardProps) => {
  ...
  return (
    <Card className="group relative overflow-hidden rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm hover:border-primary/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(236,72,153,0.15)]">
