...
import heroBg from '@/assets/sakura-hero-bg.jpg';
        ...
        <div className="relative container mx-auto px-4 text-center z-10">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-12">
              <Link to="/marketplace">
                <Button size="lg" className="btn-hero text-lg px-8 py-6 shadow-elegant hover:shadow-glow transition-all">
                  Explore Marketplace
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
              <Link to="/mint">
                <Button size="lg" variant="outline" className="text-lg px-8 py-6 glass hover:bg-gradient-sakura hover:text-white hover:border-transparent transition-all">
                  Create NFT
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="card-hover p-8 rounded-2xl bg-gradient-card text-center shadow-elegant group"
                >
                  <div className="inline-flex p-4 rounded-full bg-gradient-sakura mb-6 shadow-glow group-hover:scale-110 transition-transform">
